...
vignette: >
  %\VignetteIndexEntry{2.E: STRING & rbioapi}
...
Refer to the 'values' section `rba_string_interactions_network` function's manual for information on the returned columns.
