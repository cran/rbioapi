---
title: "3.A: Do with rbioapi: Over-Representation (Enrichment) Analysis"
...
output:
  rmarkdown::html_vignette:
    ...
    encoding: 'UTF-8'
vignette: >
  %\VignetteIndexEntry{3.A: Do with rbioapi: Over-Representation (Enrichment) Analysis}
...
# Over-representation (enrichment) analysis with rbioapi
...
[Enrichr](https://maayanlab.cloud/Enrichr/ "Enrichr") , developed in the [Ma'ayan Lab](https://icahn.mssm.edu/research/labs/maayan-laboratory/ "Ma'ayan Laboratory, Computational Systems Biology"), is a service to perform enrichment analysis against a considerable number of curated gene set libraries across various species.
