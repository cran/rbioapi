...
## Approach 1: Using the one-step Wrapper function {#approach-1-using-the-wrapper-function .heading3}
...
```{r approach_2_enrichr_results, eval=exists("results_crispr")&&is.data.frame(results_crispr), echo=FALSE}
...
# Working with Other Species {#other-species .heading2}
...
# Over-representation analysis Using Other Services {#other-services .heading2}
